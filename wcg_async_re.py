...
class wcg_async_re_job(bedam_async_re_job):
    ...
    def print_status(self):
        ...
        for k in range(self.nreplicas):
            ...
            log += fmt.format(k, stateid, self.stateparams[stateid]['lambda'], self.stateparams[stateid]['temperature'], self.status[k]['running_status'], self.status[k]['cycle_current'])
